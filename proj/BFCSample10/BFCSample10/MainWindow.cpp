...
int CMainWindow::OnClose() {
	...
	int iRet = MessageBox(m_hWnd, _T("Close CMainWindow OK?"), _T("BFCSample10"), MB_OKCANCEL);	// MessageBoxで"Close CMainWindow OK?"と表示し, 戻り値をiRetに格納.
...
int CMainWindow::OnItem1_1(WPARAM wParam, LPARAM lParam) {
	...
	// メッセージボックスを表示.
	MessageBox(NULL, _T("Item1-1"), _T("BFCSample10"), MB_OK);	// MessageBoxで"Item1-1"と表示.
